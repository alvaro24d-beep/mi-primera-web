    ...
    <mesh ref={meshRef} geometry={geometry} position={position} rotation={rotation} castShadow receiveShadow>
      {isGlass && isFrosted ? (
        ...
        <MeshTransmissionMaterial
          ...
          metalness={0.04}
          envMapIntensity={0.5}
          // (V18.43: se retira el `emissive` azul que probó V18.42 — "vuelve a
          // dejar los Liquid Glass como antes, sin el azul". El cristal se
          // queda solo con la luz que RECIBE de los Lightformers, sin ninguna
          // propia. Si alguna vez se retoma, el aviso que dejó aquella prueba
          // sigue valiendo: el emissive se suma uniforme sobre toda la cara y
          // el fondo detrás es casi negro, así que domina enseguida — a 1.15
          // la card era un bloque opaco que tapaba el contenido y a 0.28 aún
          // se leía como azul primario.)
        />
      ) : isGlass ? (

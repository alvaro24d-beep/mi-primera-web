...
// TargetCursor de React Bits (variante TS-CSS), adaptado a Nexora:
// - "use client" (App Router) y CSS movido a globals.css (sección
//   "Target cursor" — convención de hoja única del proyecto).
// - Montado vía components/CursorFx.tsx, que lo gatea por reduced-motion y
//   evita el mismatch de hidratación (el isMobile de abajo lee window).
...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  const constants = useMemo(
    () => ({
      // Sincronizado con .target-cursor-corner en globals.css (border 2px).
      borderWidth: 2,
      cornerSize: 12
    }),
    []
